...
- **Score par classificateur** : Chaque vignette porte trois métriques de l'ensemble de test, chacune sous son libellé et rappelant sa définition au survol — l'**exactitude**, le **rappel** et la **précision**. Les lire ensemble instruit, aucune ne suffisant seule : un SVM linéaire sur des lunes bruitées range presque tout dans la classe positive, d'où un rappel parfait (1.00) que démentent une exactitude de 0.42 et une précision de 0.38.
